...
4. At the Draft checkpoint use the **structured feedback step** from `run-content-week.md` §2 (checklist or one concrete sentence; inject into the next attempt). Log the feedback/edit to `clients/<client>/voice-learning-log.md` per `skills/learn-voice.md` §1.
